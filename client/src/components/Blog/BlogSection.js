                    ...
                    <div class="row">
                            <div class="col-md-7 col-lg-8">
                                ...
                                <ul class="font-14 mb-30">
                                        <li class="color-primary"><a href="c"><b> 01.</b></a></li>
                                        <li><a href="c"><b> 02.</b></a></li>
                                        <li><a href="c"><b> 03.</b></a></li>
                                </ul>
                            </div>{/*<!--col-md-8-->*/}
                            ...
                            <div class="col-md-5 col-lg-4">
                                    <div class="mx-w-400x mlr-auto">
                                            ...
                                            <div class="mb-50 mb-sm-30 pos-relative oflow-hidden">
                                                    ...
                                                    <img src={require("../../images/sidebar-1-400x600.jpg")} alt="" />
                                            ...
                                            <div class="mb-50 mb-sm-30">
                                                    ...
                                                    <div class="sided-90x mb-30 ">
                                                        <div class="s-left"><img class="br-3" src={require("../../images/sidebar-3-200x200.jpg")} alt="Menu" /></div>
                                            ...
                                            <div class="mb-30 pos-relative">
                                                    <img src={require("../../images/sidebar-2-400x600.jpg")} alt="" />
        ...
        return(
                <div class="mb-50 mb-sm-30">
                        <div class="pos-relative mb-30 pt-15">
                                ...
                                <img src={require("../../images/blog-3-1000x400.jpg")} alt="" />
                        </div>
                        <h4><a href="c"><b>Recipe of the week: Tomato pastas</b></a></h4>
                        <h6 class="mt-10 bg-lite-blue dplay-inl-block">
                                <a class="plr-20 mtb-10" href="c"><b>By Admin</b></a>
                                <a class="plr-20 mtb-10 brder-lr-lite-black-2" href="c"><b>in Recipes</b></a>
                                <a class="plr-20 mtb-10" href="c"><b>3 Comments</b></a>
                        </h6>
